...
class HardCoverNonFiction extends StatefulWidget {
  @override
  _HardCoverNonFictionState createState() => _HardCoverNonFictionState();
}

class _HardCoverNonFictionState extends State<HardCoverNonFiction> {
  List books = [];
  ...
  fetchBook() async {
    ...
    // print("fetching...");
    var url =
        "https://api.nytimes.com/svc/books/v3/lists/current/hardcover-nonfiction.json?api-key=t7tOmskK80Pexuzfq02yMtL1MWBHjJXB";
