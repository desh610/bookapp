...
class PaperbackNonFiction extends StatefulWidget {
  @override
  _PaperbackNonFictionState createState() => _PaperbackNonFictionState();
}

class _PaperbackNonFictionState extends State<PaperbackNonFiction> {
  List books = [];
  ...
  fetchBook() async {
    ...
    // print("fetching...");
    var url =
        "https://api.nytimes.com/svc/books/v3/lists/current/paperback-nonfiction.json?api-key=t7tOmskK80Pexuzfq02yMtL1MWBHjJXB";
